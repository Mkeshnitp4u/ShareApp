    ...
    return (
      <View style={commonStyles.container}>
            ...
            <View>
                ...
                <Text style = {{fontSize:40,color:'white',alignSelf:'center'}}> Personal Content</Text>
            ...
            <View style = {{height:scrheight*0.1 , width:'100%' , position:'absolute' , bottom:0 , flexDirection:'row', justifyContent:'center',padding:'5%'}}>
